...
export function Technology() {
   return (
      <section
         id="technology"
         className="w-[var(--content-width)] flex border border-[var(--stroke-color)] py-16 px-12 gap-14 h-max items-center"
      >
         <div className="mt-auto max-w-200">
            <h4 className="text-xl text-light-gray font-normal mb-2">AN ICON OF WARFARE</h4>
            <h2 className="fade-in text-8xl text-gray-gradient font-semibold mb-4">UBOAT TECHNOLOGY</h2>
