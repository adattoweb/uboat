...
export function Intro() {
   return (
      <section className="w-screen h-screen bg-[radial-gradient(circle_at_center,transparent,#061720_150%),url('/images/intro_background.png')] bg-cover bg-center flex">
